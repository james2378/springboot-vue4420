...
const routes = [
	...
	// 视频分享路由
	{
		path: '/video_sharing/table',
		name: 'video_sharing_table',
		component: () => import('../views/video_sharing/table.vue')
	},
	{
		path: '/video_sharing/view',
		name: 'video_sharing_view',
		component: () => import('../views/video_sharing/view.vue')
	},
