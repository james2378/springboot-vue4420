...
const routes = [
	...
	//视频分享列表路由
	{
		path: '/video_sharing/list',
		name: '/video_sharing_list',
		component: () => import('../views/video_sharing/list.vue')
	},
	//视频分享详情路由
	{
		path: '/video_sharing/details',
		name: '/video_sharing_details',
		component: () => import('../views/video_sharing/details.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "新闻管理系统-home";
	document.title = title;
	document.logo = "新闻管理系统"
})
